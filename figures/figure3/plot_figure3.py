...
def plot_activity_judgment_bars(bubble_data, summary_stats, output_path_base='figures/figure3/figure3'):
    """
...
def plot_series_distribution(summary_stats, config):
    ...
    # Load series data
    try:
        with open('figures/figure3/data/series_data.json', 'r') as f:
    ...
    # Save both PDF and PNG versions of the figure
    output_base = 'figures/figure3/figure3_series_distribution'
    ...
    with open('figures/figure3/metrics.json', 'w') as f:
        json.dump(metrics, f, indent=2)

if __name__ == "__main__":
    # Load the data
    try:
        with open('figures/figure3/data/bubble_data.json', 'r') as f:
            bubble_data = json.load(f)
        
        with open('figures/figure3/data/summary_stats.json', 'r') as f:
            summary_stats = json.load(f)
            
        plot_activity_judgment_bars(bubble_data, summary_stats)
        
    except FileNotFoundError:
        print("Data files not found. Run process_figure3_data.py first.")
        import process_figure3_data
        bubble_data, summary_stats, _ = process_figure3_data.process_data()
        plot_activity_judgment_bars(bubble_data, summary_stats) 