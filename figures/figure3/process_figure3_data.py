...
os.makedirs('figures/figure3/data', exist_ok=True)

def process_data():
    """Process Taskmaster UK tasks data for Figure 3 visualization."""
    # Load the dataset
    tasks_df = pd.read_csv('data/raw/taskmaster_UK_tasks.csv')
    ...
    # Save all data
    with open('figures/figure3/data/bubble_data.json', 'w') as f:
    ...
    with open('figures/figure3/data/summary_stats.json', 'w') as f:
        json.dump(summary_stats, f, indent=2)
    
    # Save series data
    with open('figures/figure3/data/series_data.json', 'w') as f:
        json.dump(series_data, f, indent=2)
    
    # Save trend analysis
    with open('figures/figure3/data/trend_analysis.json', 'w') as f:
        json.dump(trend_analysis, f, indent=2)
    
    print(f"Processed {total_tasks} tasks.")
    print("Bubble data saved to figures/figure3/data/bubble_data.json")
    print("Summary statistics saved to figures/figure3/data/summary_stats.json")
    print("Series data saved to figures/figure3/data/series_data.json")
    print("Trend analysis saved to figures/figure3/data/trend_analysis.json")
