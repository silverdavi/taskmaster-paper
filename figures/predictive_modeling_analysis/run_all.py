...
def main():
    ...
    if successful == total_scripts:
        ...
        print(f"\n📁 Generated Files:")
        print(f"   • figure8a_episode_ml.png/pdf - Episode ML analysis")
        print(f"   • figure8b_raw_correlations.png/pdf - Correlation analysis")
        print(f"   • random_forest_feature_analysis.png/pdf - Feature insights")
